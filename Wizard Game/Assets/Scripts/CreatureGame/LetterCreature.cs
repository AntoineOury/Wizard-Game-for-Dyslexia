...
namespace OtherwiseLabs.CreatureGame
{
    ...
    public class LetterCreature : MonoBehaviour
    {
        ...
        ///
        /// Design note: wild creatures of a species always behave like this.
        /// When trained companions arrive, tameness will live on the captured
        /// INDIVIDUAL (its own saved state), never on the species — do not
        /// reintroduce species-wide shyness discounts here.
        /// </summary>
